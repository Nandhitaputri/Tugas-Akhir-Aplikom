...
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-003.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-004.png}
\begin{eulerprompt}
...
>plotCircle(circleWithCenter(P,r),"Lingkaran dalam segitiga ABC"):
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-005.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-019.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-021.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-031.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-044.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-051.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-056.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-061.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-063.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-064.png}
\begin{eulerprompt}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-071.png}
\begin{eulercomment}
Tentu saja,
...
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-084.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-114.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-119.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-126.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-127.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-128.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-129.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-130.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-131.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-132.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-133.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-134.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-135.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-136.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-137.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-138.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-139.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-143.png}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Geometri_Nandhita Putri_Shalsabila-144.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-145.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-146.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-147.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-148.png}
\begin{eulerprompt}
>A=[-1,-1]; plotPoint(A,"A"):
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-149.png}
\begin{eulerprompt}
>B=[2,-2]; plotPoint(B,"B"):
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-150.png}
\begin{eulerprompt}
>C=[0,2]; plotPoint(C,"C"):
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-151.png}
\begin{eulerprompt}
>plotSegment(A,B,"a"):
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-152.png}
\begin{eulerprompt}
>plotSegment(B,C,"b"):
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-153.png}
\begin{eulerprompt}
>plotSegment(A,C,"c"):
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-154.png}
\begin{eulerprompt}
>l=angleBisector(A,B,C);
>color(2); plotLine(l); color(1):
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-155.png}
\begin{eulerprompt}
>plotCircle(c, "Lingkaran luar segitiga ABC"):
\end{eulerprompt}
\begin{euleroutput}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-156.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-157.png}
\begin{eulercomment}
3.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-158.png}
\begin{eulerprompt}
>A=[-1,-1]; plotPoint(A,"A"):
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-159.png}
\begin{eulerprompt}
>B=[1,-1]; plotPoint(B,"B"):
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-160.png}
\begin{eulerprompt}
>C=[1,1]; plotPoint(C,"C"):
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-161.png}
\begin{eulerprompt}
>D=[-1,1]; plotPoint(D,"D"):
\end{eulerprompt}
\eulerimg{17}{images/Geometri_Nandhita Putri_Shalsabila-162.png}
\begin{eulerprompt}
>plotSegment(A,B,"");
>plotSegment(B,C,"");
>plotSegment(C,D,"");
...
>aspect(1):
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-163.png}
\begin{eulerprompt}
>l=angleBisector(A,B,C);
...
>plotPoint(P,"P"):
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-164.png}
\begin{eulerprompt}
>r=norm(P-projectToLine(P,lineThrough(A,B)));
>plotCircle(circleWithCenter(P,r),"Lingkaran dalam segiempat ABCD"):
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-165.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-166.png}
\begin{eulerprompt}
>plot3d("d2",xmin=-3,xmax=3,ymin=-4,ymax=2):
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-167.png}
\begin{eulercomment}
5.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-168.png}
\begin{eulerprompt}
>plot3d("d2",xmin=-3,xmax=3,ymin=-4,ymax=2):
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-169.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-4,xmax=4):
\end{eulerprompt}
\eulerimg{27}{images/Geometri_Nandhita Putri_Shalsabila-170.png}
\end{eulernotebook}
\end{document}
